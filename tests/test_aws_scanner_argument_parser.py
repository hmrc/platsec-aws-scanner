...
class TestAwsScannerArgumentParser(AwsScannerTestCase):
    def test_parse_args_for_service_usage_task(self) -> None:
        with patch("sys.argv", "prog service_usage -u bob -t 666666 -y 2021 -m 02 -s ssm".split()):
    ...
    def test_parse_args_for_role_usage_task(self) -> None:
        with patch("sys.argv", "prog role_usage -u tom -t 654321 -y 2018 -m 1 -r RoleVerySensitive".split()):
            short_args = AwsScannerArgumentParser().parse_args()
    ...
    def test_parse_args_for_principal_task(self) -> None:
        with patch("sys.argv", "prog find_principal -u tom -t 987654 -y 2020 -m 11 -i 127.0.0.1".split()):
            short_args = AwsScannerArgumentParser().parse_args()
    ...
    def test_parse_args_for_create_table_task(self) -> None:
        with patch("sys.argv", "prog create_table -u john -t 444555 -y 2019 -m 5 -a 1,2,3".split()):
            short_args = AwsScannerArgumentParser().parse_args()
    ...
    def test_parse_args_for_list_accounts_task(self) -> None:
        with patch("sys.argv", "prog list_accounts -u rob -t 446655".split()):
            short_args = AwsScannerArgumentParser().parse_args()

        with patch("sys.argv", "prog list_accounts --username rob --token 446655".split()):
            long_args = AwsScannerArgumentParser().parse_args()
    ...
    def test_parse_args_for_list_ssm_parameters_task(self) -> None:
        with patch("sys.argv", "prog list_ssm_parameters -u kev -t 446465".split()):
            short_args = AwsScannerArgumentParser().parse_args()

        with patch("sys.argv", "prog list_ssm_parameters --username kev --token 446465".split()):
            long_args = AwsScannerArgumentParser().parse_args()
    ...
    def test_parse_args_for_drop_task(self) -> None:
        with patch("sys.argv", "prog drop -t 433516".split()):
            short_args = AwsScannerArgumentParser().parse_args()

        with patch("sys.argv", "prog drop --token 433516".split()):
            long_args = AwsScannerArgumentParser().parse_args()
