...
log-group:/aws/route53/public.aws.scanner.gov.uk.",
        ...
        values = {
            "AAAABBBBCCCCDD": expected_query_log_AAAABBBBCCCCDD,
            "IIIIIIILLLLLLL": expected_query_log_IIIIIIILLLLLLL,
        }
...
log-group:/aws/route53/public.aws.scanner.gov.uk.",
        ...
        assert responses.EXPECTED_QUERY_LOG == AwsHostedZonesClient(boto_mock).list_query_logging_configs(
            "AAAABBBBCCCCDD"
        )
    ...
    def test_create_query_log_config(self) -> None:
        ...
        route53_client.list_query_logging_configs = Mock(
            side_effect=lambda HostedZoneId: expected_list_query_logging_config
        )
