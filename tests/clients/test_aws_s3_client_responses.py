...
GET_BUCKET_TAGGING_HIGH_SENSITIVITY = {"TagSet": [{"Key": "data_sensitivity", "Value": "high"}, {"Key": "data_expiry", "Value": "1-week"}]}
GET_BUCKET_TAGGING_LOW_SENSITIVITY = {"TagSet": [{"Key": "data_sensitivity", "Value": "low"}, {"Key": "data_expiry", "Value": "1-week"}]}
...
GET_BUCKET_TAGGING_EXPIRY_1_WEEK = {"TagSet": [{"Key": "data_expiry", "Value": "1-week"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_1_MONTH = {"TagSet": [{"Key": "data_expiry", "Value": "1-month"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_90_DAYS = {"TagSet": [{"Key": "data_expiry", "Value": "90-days"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_6_MONTHS = {"TagSet": [{"Key": "data_expiry", "Value": "6-months"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_1_YEAR = {"TagSet": [{"Key": "data_expiry", "Value": "1-year"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_7_YEARS = {"TagSet": [{"Key": "data_expiry", "Value": "7-years"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_10_YEARS = {"TagSet": [{"Key": "data_expiry", "Value": "10-years"}, {"Key": "data_sensitivity", "Value": "low"}]}
GET_BUCKET_TAGGING_EXPIRY_FOREVER_CONFIG_ONLY = {"TagSet": [{"Key": "data_expiry", "Value": "forever-config-only"}, {"Key": "data_sensitivity", "Value": "low"}]}
