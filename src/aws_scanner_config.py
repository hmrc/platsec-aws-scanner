...
class AwsScannerConfig:
    ...
    def logs_route53_log_group_subscription_filter_name(self) -> str:
        return f"{self.logs_route53_log_group_name()}_sub_filter"
    ...
    def logs_route53_log_group_delivery_role_policy(self) -> str:
        return self._get_config("logs", "route53_log_group_delivery_role_policy")
    ...
    def logs_route53_log_group_delivery_role_policy_document(self) -> Dict[str, Any]:
        return self._get_json_config("logs", "route53_log_group_delivery_role_policy_document")
